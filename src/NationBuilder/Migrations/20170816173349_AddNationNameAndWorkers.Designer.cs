...
namespace NationBuilder.Migrations
{
    ...
    [Migration("20170816173349_AddNationNameAndWorkers")]
    partial class AddNationNameAndWorkers
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("NationBuilder.Models.Map", b =>
                {
            ...
            modelBuilder.Entity("NationBuilder.Models.Nation", b =>
                {
                    b.HasOne("NationBuilder.Models.Map", "Map")
                        .WithMany("Nations")
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
